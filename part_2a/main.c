	...
	for ( i = 0 ; i < size ; i ++ )
	{
		...
		for ( k = 0 ; k < dim ; k ++ )
		{
			for ( l = 0 ; l < dim ; l ++ )
			{
				...
				//printf("%f\n",*data2);
				//data0 = data0+data1+data2 kathe fora me diaforetiko deikth k,l
			}			
		}
		//mia for mporei na figei
		int r = 1 ;
...
int main(int argc, char ** argv)
{
	...
	for(i=0;i<dim*size;i++)//poio to krithrio gia na metrhsw ton xrono?
		myFunc (size, dim, threshold, data0, data1, data2);
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	/*my func Accel for dim==4 or dim==16*/
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
